...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyDG4HRxjpDPnbYC6fPJsB3ezcRUBsYfZRI")!
                    ...
                    do{
                        ...
                        if let items = jsonResult["items"] as? NSArray {
                            ...
                            for item in items as [AnyObject]{
                                ...
                                // if Apropriate, Configure the new managed object
    ...
    // Set the title of the Rows from the core Data
